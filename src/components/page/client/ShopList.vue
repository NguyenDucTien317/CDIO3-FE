                    ...
                    <div class="col-lg-3 order-lg-1 order-2">
                        ...
                        <aside class="widget widget-brand">
                            ...
                            <ul>
                                ...
                                <li>
                                    <input type="checkbox" /><a href="#">Urban outfitters</a>
                                </li>
                            ...
                            <div class="sidebar-product">
                                ...
                                <div class="single-product">
                                    <div class="product-photo">
                                        <a href="#">
                                            <img class="primary-photo" src="../../../assets/admin_2/img/sidebar/1.png"
                                                alt="" />
                                        </a>
                                    </div>
                                ...
                                <div class="single-product">
                                    <div class="product-photo">
                                        <a href="#">
                                            <img class="primary-photo" src="../../../assets/admin_2/img/sidebar/2.png"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-brief">
                                ...
                                <div class="single-product">
                                    <div class="product-photo">
                                        <a href="#">
                                            <img class="primary-photo" src="../../../assets/admin_2/img/sidebar/3.png"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-brief">
                                ...
                                <div class="single-product">
                                    <div class="product-photo">
                                        <a href="#">
                                            <img class="primary-photo" src="../../../assets/admin_2/img/sidebar/4.png"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-brief">
                                ...
                                <div class="single-product">
                                    <div class="product-photo">
                                        <a href="#">
                                            <img class="primary-photo" src="../../../assets/admin_2/img/sidebar/5.png"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-brief">
                        ...
                        <div class="shop-content">
                            ...
                            <div class="product-toolbar">
                                ...
                                <ul class="nav shop-menu view-mode">
                                    <li>
                                        <a class="grid-view active" href="#grid-view" data-bs-toggle="tab"><i
                                                class="sp-grid-view"></i></a>
                                    </li>
                                    <li>
                                        <a class="list-view" href="#list-view" data-bs-toggle="tab"><i
                                ...
                                <div class="shop-pagination">
                                    <ul>
                                        ...
                                        <li><a href="#">3</a></li>
                                        <li>
                                            <a href="#"><i class="sp-arrow-bold-right"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/1.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/9.jpg" alt="" />
                                                    </a>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/2.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/5.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                                        <a href="#" class="action-btn"><i
                                                                class="sp-heart"></i><span>Wishlist</span></a>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/3.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/8.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                                        <a href="#" class="action-btn"><i
                                                                class="sp-heart"></i><span>Wishlist</span></a>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/4.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/5.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/6.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/2.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop/7.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop/3.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop-list/1.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop-list/5.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                                        <a href="#" class="action-btn"><i
                                                                class="sp-heart"></i><span>Wishlist</span></a>
                                                ...
                                                <div class="product-brief">
                                                    ...
                                                    <div class="porduct-desc">
                                                        <p>
                                                            ...
                                                            eget, temporamet, ante. Donec eu libero sit amet
                                        ...
                                        <div class="col-lg-12">
                                            <div class="single-product">
                                                <div class="product-photo">
                                                    <a href="#">
                                                        <img class="primary-photo"
                                                            src="../../../assets/admin_2/img/shop-list/2.jpg" alt="" />
                                                        <img class="secondary-photo"
                                                            src="../../../assets/admin_2/img/shop-list/3.jpg" alt="" />
                                                    </a>
                                                    <div class="pro-action">
                                                        <a href="#" class="action-btn"><i
                                                                class="sp-heart"></i><span>Wishlist</span></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="best-product-banner">
                            <a href="#"><img src="../../../assets/admin_2/img/banner/best-product-banner.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="banner-photo">
                            <a href="#"><img src="../../../assets/admin_2/img/banner/4.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="banner-6">
                            ...
                            <span class="main-price">$144.44</span>
                            <span class="old-price-2">$288.00</span>
                            <p>
                                An oxford shirt sharp and reliable essential. durable woven
                                texture in premium two-ply cotton, it is the perfect
                                complement to suiting and urban knits.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-service">
                            ...
                            <div class="service-brief">
                                <h3>help line</h3>
                                <p>
                                    (+112) 1925184203 - call any time for any support Lorem
                                    Ipsum available, alteration
                                </p>
                            </div>
                        </div>
                    </div>
