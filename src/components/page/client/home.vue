        ...
        <div class="slider-area margin-bottom-80">
            <div class="bend niceties preview-2">
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../../../assets/admin_2/img/slider/slider-1/3.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../../../assets/admin_2/img/slider/slider-1/1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="../../../assets/admin_2/img/slider/slider-1/2.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
                ...
                <!-- <div id="ensign-nivoslider" class="slides">
                    <img src="../../../assets/admin_2/img/slider/slider-1/1.jpg" alt="" title="#slider-direction-1" />
                    <img src="../../../assets/admin_2/img/slider/slider-1/2.jpg" alt="" title="#slider-direction-2" />
                    <img src="../../../assets/admin_2/img/slider/slider-1/3.jpg" alt="" title="#slider-direction-3" />
                </div> -->
                <!-- direction 1 -->
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="slider-1">
                                ...
                                <div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
                                    <span><img src="../../../assets/admin_2/img/slider/slider-1/slider-border.png"
                                            alt="" /></span>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="single-banner fix">
                            <div class="banner-photo padding-0 float-start col-md-6">
                                <a href="#"><img src="../../../assets/admin_2/img/banner/1.jpg" alt="" /></a>
                            </div>
                        ...
                        <div class="single-banner fix">
                            ...
                            <div class="banner-photo padding-0 float-end col-md-6">
                                <a href="#"><img src="../../../assets/admin_2/img/banner/2.jpg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="new-collection-area fix margin-bottom-80">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-sm-6 padding-0">
                    <div class="single-collection">
                        <div class="collection-photo">
                            <a href="#"><img src="../../../assets/admin_2/img/new-collection/1.jpg" alt="" /></a>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-sm-6 padding-0">
                    <div class="single-collection">
                        <div class="collection-photo">
                            <a href="#"><img src="../../../assets/admin_2/img/new-collection/2.jpg" alt="" /></a>
                        </div>
                        <div class="collection-brief">
                            <div class="text-right">
                                <span class="new">new</span>
                ...
                <div class="col-xl-4 col-md-6 col-sm-6 padding-0">
                    <div class="single-collection">
                        <div class="collection-photo">
                            <a href="#"><img src="../../../assets/admin_2/img/new-collection/3.jpg" alt="" /></a>
                        </div>
                        <div class="collection-brief">
                            <div class="text-right">
                                <span class="new">new</span>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="single-product">
                            <div class="product-photo">
                                <a href="#">
                                    <img class="primary-photo" src="../../../assets/admin_2/img/product/1.jpg" alt="" />
                                    <img class="secondary-photo" src="../../../assets/admin_2/img/product/5.jpg" alt="" />
                                </a>
                                <div class="pro-action">
                                    <a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
                                    <a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to
                                            cart</span></a>
                    ...
                    <div class="col-4">
                        <div class="single-product">
                            <div class="product-photo">
                                <a href="#">
                                    <img class="primary-photo" src="../../../assets/admin_2/img/product/2.jpg" alt="" />
                                    <img class="secondary-photo" src="../../../assets/admin_2/img/product/4.jpg" alt="" />
                                </a>
                                <div class="pro-action">
                                    <a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
                                    <a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to
                    ...
                    <div class="col-4">
                        <div class="single-product">
                            <div class="product-photo">
                                <a href="#">
                                    <img class="primary-photo" src="../../../assets/admin_2/img/product/3.jpg" alt="" />
                                    <img class="secondary-photo" src="../../../assets/admin_2/img/product/1.jpg" alt="" />
                                </a>
                                <div class="pro-action">
                                    <a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
                                    <a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 padding-0">
                            <div class="single-promo-banner promo-banner-1">
                                <!-- <img src="../../../assets/admin_2/img/banner/promo-banner/1.jpg" alt="" /> -->
                        ...
                        <div class="col-lg-6 padding-0">
                            <div class="single-promo-banner promo-banner-2">
                                <!-- <img src="../../../assets/admin_2/img/banner/promo-banner/2.jpg" alt="" /> -->
                                <div class="promo-banner-brief">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul role="tablist" class="nav d-block best-sell-menu">
                            <li role="presentation"><a class="active" href="#men" role="tab" data-bs-toggle="tab">Men</a>
                            </li>
                            <li role="presentation"><a href="#women" role="tab" data-bs-toggle="tab">Women</a></li>
                            <li role="presentation"><a href="#accessories" role="tab" data-bs-toggle="tab">Accessories</a>
                            </li>
                        </ul>
                        <!-- best-sell-product -->
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="product-photo">
                                                <a href="#">
                                                    <img class="primary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/1.jpg" alt="" />
                                                    <img class="secondary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/6.jpg" alt="" />
                                                </a>
                                                <div class="pro-action">
                                                    <a href="#" class="action-btn"><i
                                                            class="sp-heart"></i><span>Wishlist</span></a>
                                                    <a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add
                                                            to cart</span></a>
                                                    <a href="#" class="action-btn"><i
                                        ...
                                        <div class="single-product">
                                            <div class="product-photo">
                                                <a href="#">
                                                    <img class="primary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/4.jpg" alt="" />
                                                    <img class="secondary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/1.jpg" alt="" />
                                                </a>
                                                <div class="pro-action">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product">
                                            <div class="product-photo">
                                                <a href="#">
                                                    <img class="primary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/2.jpg" alt="" />
                                                    <img class="secondary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/4.jpg" alt="" />
                                                </a>
                                                <div class="pro-action">
                                        ...
                                        <div class="single-product">
                                            <div class="product-photo">
                                                <a href="#">
                                                    <img class="primary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/5.jpg" alt="" />
                                                    <img class="secondary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/1.jpg" alt="" />
                                                </a>
                                                <div class="pro-action">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="single-product">
                                            <div class="product-photo">
                                                <a href="#">
                                                    <img class="primary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/3.jpg" alt="" />
                                                    <img class="secondary-photo"
                                                        src="../../../assets/admin_2/img/best-sell/5.jpg" alt="" />
                                                </a>
                                                <div class="pro-action">
                                ...
                                <div class="col-lg-7 col-md-8 offset-md-1 offset-lg-2">
                                    <div class="all-product-brief">
                                        ...
                                        <p>There are many variations of passages of Lorem Ipsum available, but the
                                            majority have suffered alteration in some form. There are many variations of
            ...
            <div class="container">
                <div class="row cus-row-1">
                    <div class="single-featured single-featured-1 featured-link">
                        <a href="#"><img src="../../../assets/admin_2/img/featured/1.jpg" alt="" /></a>
                    ...
                    <div class="single-featured single-featured-2">
                        <div class="single-featured-inner featured-link">
                            <a href="#"><img src="../../../assets/admin_2/img/featured/2.jpg" alt="" /></a>
                            <div class="featured-brief">
                                <a href="#"><i class="sp-arrow-long-right"></i></a>
                            </div>
                        </div>
                        <div class="single-featured-inner featured-link">
                            <a href="#"><img src="../../../assets/admin_2/img/featured/3.jpg" alt="" /></a>
                            <div class="featured-brief">
                                <a href="#"><i class="sp-arrow-long-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="single-featured single-featured-1 featured-link">
                        <a href="#"><img src="../../../assets/admin_2/img/featured/4.jpg" alt="" /></a>
                        <div class="featured-brief">
                            <a href="#"><i class="sp-arrow-long-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div class="brand-logo fix">
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/1.png" alt="" />
                            </div>
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/2.png" alt="" />
                            </div>
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/3.png" alt="" />
                            </div>
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/4.png" alt="" />
                            </div>
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/5.png" alt="" />
                            </div>
                            <div class="single-logo">
                                <img src="../../../assets/admin_2/img/brand/6.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="single-testimonial row">
                                        <div class="col-lg-4">
                                            <div class="client-photo">
                                                <img src="../../../assets/admin_2/img/testimonial/1.png" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="client-opinion">
                                                ...
                                                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It
                                                    has rootsContrary to popular belief, Lorem Ipsum is not simply
                                                    random text. It has roots. Contrary to popular belief, Lorem Ipsum
                                                    is not simply random text. It has roots Contrary to popular belief,
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <div class="blog-photo">
                                <a href="#"><img src="../../../assets/admin_2/img/blog/1.jpg" alt="" /></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <div class="blog-photo">
                                <a href="#"><img src="../../../assets/admin_2/img/blog/2.jpg" alt="" /></a>
                                <div class="blog-post-date">
                                    <span>13th</span>
                                    <span>Feb</span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <div class="blog-photo">
                                <a href="#"><img src="../../../assets/admin_2/img/blog/3.jpg" alt="" /></a>
                                <div class="blog-post-date">
                                    <span>25th</span>
                                    <span>Feb</span>
                                </div>
